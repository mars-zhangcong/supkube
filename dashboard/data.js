...
const ADRS = [
  ...
  { id: "ADR-040", title: "DR Topology SVG 视觉规范（让号自 038）", date: "2026-06-02", status: "草稿", note: "🔄 PRD-010 让号 · PRD-Review 第六份 §二（占号待 PRD-010 实施落地）" },
  ...
  { id: "ADR-047", title: "禁止幽灵配置（No Phantom Config）：配置值必须有断了会大声失败的消费链路（跨层绑定有端到端测试 / 传子系统的 key 对照真实 schema / 每个 key 指得出消费者行）。机械落地=CI `Phantom Config Guard` + Helm 接缝测试 + `internal/velerons`/`supkube.veleroNamespace` 单一真源 + 删死值 `namespaceOverride`。教训=2026-06-04 Velero ns 事故（死值 + 后端 80+ 硬编码 ns）", date: "", status: "草稿", note: "Velero ns 事故 / Mars 决策 2026-06-04" },
];
