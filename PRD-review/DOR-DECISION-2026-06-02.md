...
| 类别 | 数量 | PRD 编号 |
|---|---|---|
| **立即开工** (主体过 DoR + Rule H 应尽则尽) | **9** | PRD-002, PRD-003, PRD-004, PRD-005, PRD-006, PRD-007, PRD-008, PRD-009, PRD-010, PRD-011 |
...
- ⏳ PRD-008/010/011 走 **Rule H 应尽则尽**: 主体可推, 关联 ADR 草稿待写部分隔离 (Mars 2026-06-03 已实质拍板进研发, 与 ENGINEERING §6.2 实质判断口径一致)
...
| **PRD-010** | ✅ 研发中 | ✅ F1-F4 + M-6/M-7 回填 | ✅ DoD #13-#16 | ⚠️ ADR-040 SVG 规范占号待写 (Rule H 隔离 + 主体可推) | ❌ ADR-040 占号待写 | ✅ | **⏳ 应尽则尽 (Rule H 主体推进 + 先落 ADR-040 正文)** |
| **PRD-011** | ✅ 研发中 | ✅ H1/H2/H5 + §4.6 API 回填 | ✅ DoD #14-#17 (D-WAIT-002 数值已拍) | ⚠️ ADR-043 + ADR-046 占号待写 (Rule H 隔离) | ❌ ADR-043/046 占号待写 | ✅ | **⏳ 应尽则尽 (Rule H 主体推进 + 评分细则 ADR 先落)** |
