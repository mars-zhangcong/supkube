...
| 类别 | 数量 | PRD 编号 |
|---|---|---|
| **立即开工** (全部 DoR 6 条过 + 部分走 Rule H 隔离) | **11** | PRD-001 (Mars D-WAIT-003 拍板), PRD-002, PRD-003, PRD-004, PRD-005, PRD-006, PRD-007, PRD-009, PRD-010, PRD-011 + Rule H 隔离 PRD-008 |
| **暂缓整改** | **4** | PRD-012 (Case API), PRD-013 (草稿), PRD-014 (charter), PRD-015 (charter) |
...
- ✅ **PRD-001 已进研发** (Mars 2026-06-03 D-WAIT-003 拍板, 跟 008/009/010/011 一道 — 4 finding + T3 拓扑校验 §4 + §8 DoD 已完整落地, 直接通过重审)
...
|---|---|---|---|---|---|---|---|
| **PRD-001** | ✅ 研发中 (Mars 2026-06-03 D-WAIT-003 拍板) | ✅ 4 finding + T3 拓扑校验 §4 + §8 DoD #6/#7/#10 | ✅ DoD 完整 | ✅ 关联 PRD-002 已就绪 | ✅ ADR-031 Decided | ✅ | **✅ 立即开工 (Mars 跳过形式重审, 直接进研发)** |
...
### ✅ PRD-001 — Mars 2026-06-03 D-WAIT-003 拍板**已进研发** (从暂缓升级)
- **决策**: Mars 选方案 A "跟 PRD-008/009/010/011 一道 走 Mars 评审通过 → 进研发"
- **状态**: 改正中 → **研发中**
- **就绪程度**: DoR 6 条全过 (Claude 已修订完 4 finding + T3 拓扑校验落 §4 + §8 DoD #6/#7/#10)
...
| ID | 内容 | 优先级 |
|---|---|---|
| (闭环) **D-WAIT-001** | CD OIDC + RBAC (Mars 已修) | 🟢 已闭环 |
| (闭环) **D-WAIT-002** | PRD-011 4 维 25/35/20/20 评分数值 (Mars 已拍) | 🟢 已闭环 |
| (闭环) **D-WAIT-003** | PRD-001 改正中状态澄清 (Mars 拍方案 A: 跟 008/009/010/011 一道进研发) | 🟢 已闭环 2026-06-03 |
| (闭环) **D-WAIT-004** | 工程周期闭环 (Mars 拍 9 阶段拆解 + Test Report 放测试用例.md + CICD 双集群闭环, ENGINEERING §7 重写) | 🟢 已闭环 2026-06-03 |
| (闭环) **D-WAIT-005** | ADR 决策口径 (Mars 拍方案 A: PRD-008/010/011 主体走 Rule H 应尽则尽推进; "应尽则尽 ≠ 应进则进", 三铁律一体) | 🟢 已闭环 2026-06-03 |
